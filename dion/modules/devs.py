...
from dion.config import OWNER_ID, BOT_NAME
from dion.database.chats import blacklist_chat, blacklisted_chats, whitelist_chat
from dion.utils.decorators import sudo_users_only
from dion.utils.filters import command
from dion.modules import check_heroku


@app.on_message(command(["rebootmusic", "mrestart"]) & filters.user(OWNER_ID))
@check_heroku
