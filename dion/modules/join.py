...
from dion import app, ASSUSERNAME
from dion.utils.decorators import sudo_users_only, errors
...
@app.on_message(
    command(["userbotjoin", "dionjoin", "oj"]) & ~filters.private & ~filters.bot
)
@errors
...
@USER.on_message(filters.group & command(["userbotleave", "dionleave", "dionleft"]))
